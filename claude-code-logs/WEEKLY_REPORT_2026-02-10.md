...
| 指标 | 合成输入 | 已完成 | resolved | 解决比例 | LLM 调用 | tokens | 费用（¥） | timeout/error |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| synthetic | 81 | 81 | 23 | 28.4% | 105 | 2.093M | ¥3.54 | 1/7 |
| seed | 53 | 53 | 4 | 7.5% | 87 | 1.702M | ¥2.80 | 0/7 |
| total | 134 | 134 | 27 | 20.1% | 192 | 3.795M | ¥6.34 | 1/14 |

### SWE-Agent 求解（synthetic only）

| 指标 | 合成输入 | 已完成 | resolved | unresolved | LLM 调用 | tokens | 费用（¥） | timeout/error |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 数量 | 81 | 27 | 8 | 18 | 37 | 0.746M | ¥1.26 | 0/1 |
