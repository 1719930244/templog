...
\begin{itemize}
  ...
  \item \textbf{南京医科大学康达学院} \hfill 护理学 \hfill \textbf{本科} (2019.09 -- 2021.07) \\
  获学院优秀学生奖学金（三等）、优秀实习生
...
\begin{itemize}
    \item \textbf{南京大学医学院附属鼓楼医院 | 泌尿外科 | 护师} \hfill \textbf{2021.08 -- 至今}
    \begin{itemize}
        ...
        \item 工作态度积极，服务质量优异，收到患者及家属表扬信30余封、锦旗1面
    \end{itemize}
\end{itemize}
...
\begin{itemize}
        \item
        \textbf{第一作者论文（投稿齐鲁护理杂志）} \hfill \textbf{2025.06 -- 至今}
          \\
        \textbf{论文题目: } 《基于时效性激励理论的护理干预在经尿道前列腺热蒸汽消融术患者的应用效果研究》
        \\
        \textbf{研究设计: } 采用随机对照试验（RCT），纳入100例前列腺热蒸汽消融术患者（随机分为观察组和对照组各50例）。对照组实施常规护理，观察组在此基础上实施基于时效性激励理论的系统化护理干预。采用IPSS、控尿能力、VAS、SAS/SDS、治疗依从性及护理满意度作为评估指标。
        \\
        \textbf{研究结果: } 术后1个月，观察组IPSS评分、SAS/SDS评分均显著低于对照组（\textbf{P<0.001}），控尿能力、治疗依从性和护理满意度显著提升（\textbf{P<0.05}）；术后1日和1周VAS评分均显著低于对照组（\textbf{P<0.001}）。
        \\
        \textbf{研究结论: } 时效性激励护理显著改善前列腺热蒸汽消融术后患者的前列腺症状、焦虑抑郁情绪及疼痛程度，提升控尿能力、治疗依从性和护理满意度，具有临床推广价值。

        \item
        \textbf{项目基金} \hfill \textbf{2024 -- 2026}
        \begin{itemize}
